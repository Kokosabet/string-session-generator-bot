...
Devoleper :- [𝒌𝒐𝒌𝒐](https://t.me/T_G_L)
...
async def generate_str(c, m):
    ...
    try:
        ...
        await m.reply("ارسل رقمك بشكل صحيح.`\n\nPress /start to create again.")
        return
...
async def help_cb(c, m, cb=True):
    help_text = """**هل تريد مساعده؟ **


>> اضغط على زر البدايه

>> إرسل API_ID الخاص بك عندما يسأل البوت.

>> ثم أرسل api_hash الخاص بك عندما يسأل البوت.

>> أرسل رقم هاتفك.

>> ارسل الكود اللي وصل OTP Recivived إلى رقمك في التنسيق 1 2 3 4 5 (إعطاء الفضاء B / W كل رقم)

>> (إذا كان لديك التحقق بخطوتين ، أرسله إلى البوت إذا طلب.)


**NOTE:**

إذا قمت بـ أي خطأ في أي مكان، اضغط على /cancel ثم اضغط على /start
"""
...
__✨ المطور:__ [𝒌𝒐𝒌𝒐](https://t.me/T_G_L)
